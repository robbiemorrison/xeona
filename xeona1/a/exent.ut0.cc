...
//
//  file-role        : entity exception classes / unit test
//  file-status      : working
//  file-release-tag :
//
//  LEGAL NOTICE
...
//
//  $Author: robbie $
//  $URL: file:///home/robbie/svn-root/xeona/futz/trunk/xeona1/a/exent.ut0.cc $
//
...
#include "exent.h"            // unit under test (place early)
...
{
  bool buggy()
    throw(xeona::entity_issue)               // catch all
  {
    logga::spLogger logger = logga::ptrLogStream();  // main function logger
    logger->repx(logga::dbug, "entering member function", "");
    throw xeona::entity_issue("line1\n   line2");
    return true;
  }
} // unnamed namespace
...
main(int argc, char* argv[])
{
...

  {
    ...
    catch ( const xeona::ent_exception& ex )
      {
        put << ex.expl() << "\n";
